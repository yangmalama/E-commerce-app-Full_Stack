    ...
    <div className="w-10/12 mx-auto mt-8 space-y-8 ">
      ...
      <div className="flex items-center justify-between gap-10 overflow-hidden">
        ...
        <img
          src="/blog-img-1.jpg"
          alt=""
          className="rounded-md h-90 w-170 transition-transform duration-300 ease-in-out object-cover hover:scale-110 cursor-pointer"
        />

        {/* second child: right */}
        <div className="space-y-2">
          <p className="text-2xl font-semibold hover:text-green-500 cursor-pointer ">
          ...
          <div className="grid grid-cols-2 opacity-65 text-sm">
            <p>22 April 2023</p>
            <p>
              Read time:<span className="font-bold">12min</span>
            </p>
          </div>
        </div>
      </div>
        ...
        {data.map((eachItem, index) => (
          <div className="space-y-2 overflow-hidden" key={index}>
            <img
              src={eachItem.image}
              alt=""
              className="rounded-md cursor-pointer transition-transform duration-300 ease-in-out object-cover hover:scale-110"
            />
            <p className="text-sm font-semibold text-green-500 hover:text-green-700 cursor-pointer">
              {eachItem.category}
            </p>
            <p className="text-lg font-semibold hover:text-green-500 cursor-pointer">
              {eachItem.title}
            </p>
            ...
            <div className="grid grid-cols-2 opacity-65 text-sm">
              ...
              <p>
                Read time:{" "}
                <span className="font-bold">{eachItem.readTime}</span>
              </p>
            </div>
          </div>
        ))}
